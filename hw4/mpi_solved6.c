 ...
 ******************************************************************************/
/* Need to use  MPI_Wait after non blocking operation to make sure the buffer is available now. To fix the bug, 
 * add MPI_Wait function after each non-blocking operation.
 * In rank 1, the offset should be initialized as 0.
 */
